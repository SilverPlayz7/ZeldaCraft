...
public class AnchientCapsuleMachineTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public AnchientCapsuleMachineTileEntity(BlockPos pos, BlockState state) {
		super(ZeldaCraftModBlockEntities.ANCHIENT_CAPSULE_MACHINE.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(AnchientCapsuleMachineBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<AnchientCapsuleMachineTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<AnchientCapsuleMachineTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("anchient_capsule_machine");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Ancient Capsule Machine");
	}
