...
import zeldacraft.procedures.LensOfTruthOnPlayerStoppedUsingProcedure;
...
public class LensOfTruthItem extends Item {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		LensOfTruthRightclickedProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity);
	}
