...
import zeldacraft.procedures.SmallRupeeCounterProcedure;

import zeldacraft.item.inventory.ChildWalletInventoryCapability;
...
public class ChildWalletItem extends Item implements ICurioItem {
	public ChildWalletItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Child Wallet");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new WalletDepositMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new ChildWalletInventoryCapability();
	}
