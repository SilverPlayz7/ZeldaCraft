...
public class HookShotWhileProjectileFlyingTickProcedure {
	public static void execute(LevelAccessor world, Entity entity, Entity immediatesourceentity) {
		...
		double MVX = 0;
		double NDVZ = 0;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == ZeldaCraftModItems.HOOK_SHOT.get() && entity instanceof Player _plrCldCheck3
				...
				|| (entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == ZeldaCraftModItems.HOOK_SHOT.get() && entity instanceof Player _plrCldCheck7
