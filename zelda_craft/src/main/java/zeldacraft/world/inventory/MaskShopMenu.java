...
public class MaskShopMenu extends AbstractContainerMenu implements ZeldaCraftModMenus.MenuAccessor {
	...
	public MaskShopMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ZeldaCraftModMenus.MASK_SHOP.get(), id);
		...
		for (int si = 0; si < 3; ++si)
			for (int sj = 0; sj < 9; ++sj)
				this.addSlot(new Slot(inv, sj + (si + 1) * 9, 62 + 8 + sj * 18, 55 + 84 + si * 18));
		for (int si = 0; si < 9; ++si)
			this.addSlot(new Slot(inv, si, 62 + 8 + si * 18, 55 + 142));
	}
