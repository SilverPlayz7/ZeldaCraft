...
public class FrozenIceEntity extends Monster {
	public FrozenIceEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ZeldaCraftModEntities.FROZEN_ICE.get(), world);
	}

	public FrozenIceEntity(EntityType<FrozenIceEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(true);
