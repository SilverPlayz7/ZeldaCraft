...
public class ModelAllNightMask<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("zelda_craft", "model_all_night_mask"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Mask.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 10).addBox(0.0F, -3.7F, -1.0F, 0.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.024F, -3.95F, -3.025F, 0.0F, 3.1416F, 0.0F));
		PartDefinition cube_r2 = Mask.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 10).mirror().addBox(0.0F, -3.7F, -1.0F, 0.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-4.024F, -3.95F, -3.025F, 0.0F, -3.1416F, 0.0F));
		PartDefinition cube_r3 = Mask.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(-3, 8).addBox(-4.0F, 0.0F, -3.0F, 8.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)),
