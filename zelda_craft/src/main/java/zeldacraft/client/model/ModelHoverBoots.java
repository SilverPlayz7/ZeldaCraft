...
public class ModelHoverBoots<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("zelda_craft", "model_hover_boots"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r5 = bone4.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(58, 0).mirror().addBox(2.85F, -0.4F, -3.325F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-11.4278F, -0.4078F, -3.9878F, 0.9303F, -0.4843F, -0.5922F));
		PartDefinition cube_r6 = bone4.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(58, 0).addBox(-1.8F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.5722F, -0.4078F, -3.9878F, 0.9303F, 0.4843F, 0.5922F));
		PartDefinition cube_r7 = bone4.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(7, 52).mirror().addBox(-0.425F, -0.5F, -0.55F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-4.1832F, -1.1804F, -3.6249F, -2.2751F, -1.1343F, 2.0924F));
		PartDefinition cube_r8 = bone4.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(7, 52).addBox(-0.575F, -0.5F, -0.55F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.6168F, -1.1804F, -3.6249F, -2.2751F, 1.1343F, -2.0924F));
		PartDefinition cube_r9 = bone4.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(7, 52).addBox(-0.5F, -0.35F, -0.375F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.9168F, -1.3668F, -3.683F, -0.3927F, 0.0F, 0.0F));
		PartDefinition cube_r10 = bone4.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(7, 52).addBox(-1.9F, -1.9F, -0.35F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.554F, -0.8987F, 1.9919F, 0.0381F, -0.1704F, 1.3494F));
		PartDefinition cube_r11 = bone4.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(7, 52).mirror().addBox(0.2F, -1.2F, -0.35F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r13 = bone4.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(7, 52).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r15 = bone4.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(6, 51).mirror().addBox(-1.0F, -0.5F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-6.341F, -0.8544F, -2.9093F, 0.0F, -0.0873F, 0.0F));
		PartDefinition cube_r16 = bone4.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(6, 51).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.509F, -0.8544F, -2.9093F, 0.0F, 0.0873F, 0.0F));
		PartDefinition Wing = bone4.addOrReplaceChild("Wing", CubeListBuilder.create(), PartPose.offsetAndRotation(-3.0F, -2.1677F, 2.9742F, -0.2618F, 0.2182F, 0.0F));
		PartDefinition cube_r17 = Wing.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(50, 33).addBox(6.0F, -0.75F, -1.0F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-6.5F, 0.3402F, -0.8001F, 0.7854F, 0.0F, 0.0F));
		PartDefinition cube_r18 = Wing.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(51, 34).addBox(6.0F, -0.75F, 0.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-6.5F, -0.8722F, 0.2461F, 0.2182F, 0.0F, 0.0F));
		PartDefinition cube_r19 = Wing.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(51, 34).addBox(6.0F, -1.2F, 0.0F, 1.0F, 1.2F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-6.5F, 0.7131F, 1.3293F, 1.0908F, 0.0F, 0.0F));
		PartDefinition cube_r20 = Wing.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(52, 35).addBox(6.0F, -1.25F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-6.5F, 1.9177F, -1.4742F, 0.7854F, 0.0F, 0.0F));
		PartDefinition cube_r21 = Wing.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(50, 33).addBox(6.0F, -1.0F, 0.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Right = partdefinition.addOrReplaceChild("Right",
				...
				PartPose.offset(-2.0F, 12.0F, 0.0F));
		PartDefinition cube_r22 = Right.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(58, 0).addBox(-4.85F, -0.4F, -3.325F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.4278F, 11.5922F, -4.2378F, 0.9303F, 0.4843F, 0.5922F));
		PartDefinition cube_r23 = Right.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(58, 0).mirror().addBox(-0.2F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r24 = bone9.addOrReplaceChild("cube_r24", CubeListBuilder.create().texOffs(6, 51).mirror().addBox(-2.6061F, -0.1102F, -3.1114F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r25 = bone10.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(7, 52).addBox(2.2394F, 0.6734F, -0.4387F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r26 = bone11.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(7, 52).mirror().addBox(-0.5082F, 0.6913F, -3.2093F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r27 = bone12.addOrReplaceChild("cube_r27", CubeListBuilder.create().texOffs(6, 51).addBox(0.6061F, -0.1102F, -3.1114F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.925F, -1.2443F, -0.666F, 0.0F, 0.0873F, 0.0F));
		PartDefinition bone13 = Right.addOrReplaceChild("bone13", CubeListBuilder.create(), PartPose.offset(-5.0F, 12.0F, -0.25F));
		PartDefinition cube_r28 = bone13.addOrReplaceChild("cube_r28", CubeListBuilder.create().texOffs(7, 52).mirror().addBox(-3.2288F, 0.6625F, -0.3911F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(4.925F, -1.2443F, -0.666F, -2.2751F, -1.1343F, 2.0924F));
		...
		PartDefinition cube_r29 = bone14.addOrReplaceChild("cube_r29", CubeListBuilder.create().texOffs(3, 48).addBox(0.5778F, 0.4384F, -2.7876F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r30 = bone15.addOrReplaceChild("cube_r30", CubeListBuilder.create().texOffs(3, 48).addBox(-1.2158F, -2.7986F, -1.7961F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r31 = bone17.addOrReplaceChild("cube_r31", CubeListBuilder.create().texOffs(3, 48).mirror().addBox(-0.7842F, -2.7986F, -1.7961F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-3.075F, 3.5469F, 1.2719F, 0.1309F, 0.6545F, 0.0F));
		...
		PartDefinition cube_r32 = bone19.addOrReplaceChild("cube_r32", CubeListBuilder.create().texOffs(3, 48).mirror().addBox(-2.5778F, 0.4384F, -2.7876F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-3.575F, 0.9995F, 3.4815F, -0.0876F, -0.0869F, 0.0076F));
		...
		PartDefinition cube_r33 = bone23.addOrReplaceChild("cube_r33", CubeListBuilder.create().texOffs(7, 52).addBox(0.4993F, 0.3468F, 2.2075F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r34 = bone24.addOrReplaceChild("cube_r34", CubeListBuilder.create().texOffs(7, 52).mirror().addBox(-2.4993F, 0.3468F, 2.2075F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(4.925F, -1.2443F, -0.666F, 0.1745F, 0.0F, 0.0F));
		PartDefinition bone25 = Right.addOrReplaceChild("bone25", CubeListBuilder.create(), PartPose.offset(-5.0F, 12.0F, -0.25F));
		PartDefinition cube_r35 = bone25.addOrReplaceChild("cube_r35", CubeListBuilder.create().texOffs(7, 52).mirror().addBox(-0.7467F, -1.1124F, 2.2075F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r36 = bone26.addOrReplaceChild("cube_r36", CubeListBuilder.create().texOffs(7, 52).mirror().addBox(-0.4743F, -0.5529F, 2.2461F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r37 = bone27.addOrReplaceChild("cube_r37", CubeListBuilder.create().texOffs(7, 52).addBox(-1.2533F, -1.1124F, 2.2075F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.925F, -1.2443F, -0.666F, 0.0381F, -0.1704F, 1.3494F));
		PartDefinition bone28 = Right.addOrReplaceChild("bone28", CubeListBuilder.create(), PartPose.offset(-5.0F, 12.0F, -0.25F));
		PartDefinition cube_r38 = bone28.addOrReplaceChild("cube_r38", CubeListBuilder.create().texOffs(7, 52).mirror().addBox(-2.2493F, 0.7665F, 2.224F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r39 = bone29.addOrReplaceChild("cube_r39", CubeListBuilder.create().texOffs(9, 52).mirror().addBox(1.2507F, 0.7665F, 2.224F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(4.925F, -1.2443F, -0.666F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition bone31 = Right.addOrReplaceChild("bone31", CubeListBuilder.create(), PartPose.offset(-5.0F, 12.0F, -0.25F));
		PartDefinition Wing2 = bone31.addOrReplaceChild("Wing2", CubeListBuilder.create(), PartPose.offsetAndRotation(3.0F, -2.1677F, 2.9742F, -0.2618F, -0.2182F, 0.0F));
		PartDefinition cube_r40 = Wing2.addOrReplaceChild("cube_r40", CubeListBuilder.create().texOffs(50, 33).mirror().addBox(-7.0F, -1.0F, 0.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(6.5F, 1.9809F, -1.3896F, 0.4363F, 0.0F, 0.0F));
		PartDefinition bone32 = Right.addOrReplaceChild("bone32", CubeListBuilder.create(), PartPose.offset(-5.0F, 12.0F, -0.25F));
		PartDefinition Wing3 = bone32.addOrReplaceChild("Wing3", CubeListBuilder.create(), PartPose.offsetAndRotation(3.0F, -2.1677F, 2.9742F, -0.2618F, -0.2182F, 0.0F));
		PartDefinition cube_r41 = Wing3.addOrReplaceChild("cube_r41", CubeListBuilder.create().texOffs(52, 35).mirror().addBox(-7.0F, -1.25F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(6.5F, 1.9177F, -1.4742F, 0.7854F, 0.0F, 0.0F));
		PartDefinition bone33 = Right.addOrReplaceChild("bone33", CubeListBuilder.create(), PartPose.offset(-5.0F, 12.0F, -0.25F));
		PartDefinition Wing4 = bone33.addOrReplaceChild("Wing4", CubeListBuilder.create(), PartPose.offsetAndRotation(3.0F, -2.1677F, 2.9742F, -0.2618F, -0.2182F, 0.0F));
		PartDefinition cube_r42 = Wing4.addOrReplaceChild("cube_r42", CubeListBuilder.create().texOffs(51, 34).mirror().addBox(-7.0F, -1.2F, 0.0F, 1.0F, 1.2F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(6.5F, 0.7131F, 1.3293F, 1.0908F, 0.0F, 0.0F));
		PartDefinition bone34 = Right.addOrReplaceChild("bone34", CubeListBuilder.create(), PartPose.offset(-5.0F, 12.0F, -0.25F));
		PartDefinition Wing5 = bone34.addOrReplaceChild("Wing5", CubeListBuilder.create(), PartPose.offsetAndRotation(3.0F, -2.1677F, 2.9742F, -0.2618F, -0.2182F, 0.0F));
		PartDefinition cube_r43 = Wing5.addOrReplaceChild("cube_r43", CubeListBuilder.create().texOffs(51, 34).mirror().addBox(-7.0F, -0.75F, 0.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(6.5F, -0.8722F, 0.2461F, 0.2182F, 0.0F, 0.0F));
		PartDefinition bone35 = Right.addOrReplaceChild("bone35", CubeListBuilder.create(), PartPose.offset(-5.0F, 12.0F, -0.25F));
		PartDefinition Wing6 = bone35.addOrReplaceChild("Wing6", CubeListBuilder.create(), PartPose.offsetAndRotation(3.0F, -2.1677F, 2.9742F, -0.2618F, -0.2182F, 0.0F));
		PartDefinition cube_r44 = Wing6.addOrReplaceChild("cube_r44", CubeListBuilder.create().texOffs(50, 33).mirror().addBox(-7.0F, -0.75F, -1.0F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(6.5F, 0.3402F, -0.8001F, 0.7854F, 0.0F, 0.0F));
