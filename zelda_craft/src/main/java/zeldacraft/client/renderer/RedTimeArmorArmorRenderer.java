...
import zeldacraft.item.model.RedTimeArmorModel;
...
public class RedTimeArmorArmorRenderer extends GeoArmorRenderer<RedTimeArmorItem> {
	public RedTimeArmorArmorRenderer() {
		super(new RedTimeArmorModel());
	...
	@Override
	public RenderType getRenderType(RedTimeArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
