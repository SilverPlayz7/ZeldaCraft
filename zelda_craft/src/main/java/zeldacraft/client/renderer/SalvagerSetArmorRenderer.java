...
import zeldacraft.item.model.SalvagerSetModel;
...
public class SalvagerSetArmorRenderer extends GeoArmorRenderer<SalvagerSetItem> {
	public SalvagerSetArmorRenderer() {
		super(new SalvagerSetModel());
	...
	@Override
	public RenderType getRenderType(SalvagerSetItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
