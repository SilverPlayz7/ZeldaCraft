...
import zeldacraft.item.model.BlueTimeArmorModel;
...
public class BlueTimeArmorArmorRenderer extends GeoArmorRenderer<BlueTimeArmorItem> {
	public BlueTimeArmorArmorRenderer() {
		super(new BlueTimeArmorModel());
	...
	@Override
	public RenderType getRenderType(BlueTimeArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
