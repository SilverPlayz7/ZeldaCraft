...
import zeldacraft.item.model.WindArmorModel;
...
public class WindArmorArmorRenderer extends GeoArmorRenderer<WindArmorItem> {
	public WindArmorArmorRenderer() {
	...
	@Override
	public RenderType getRenderType(WindArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
