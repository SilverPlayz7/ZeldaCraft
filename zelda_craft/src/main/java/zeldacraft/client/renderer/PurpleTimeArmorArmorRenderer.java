...
import zeldacraft.item.model.PurpleTimeArmorModel;
...
public class PurpleTimeArmorArmorRenderer extends GeoArmorRenderer<PurpleTimeArmorItem> {
	public PurpleTimeArmorArmorRenderer() {
		super(new PurpleTimeArmorModel());
	...
	@Override
	public RenderType getRenderType(PurpleTimeArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
