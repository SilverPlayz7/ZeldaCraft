...
public class LongShotProjectileRenderer extends EntityRenderer<LongShotProjectileEntity> {
	...
	public LongShotProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
	...
	@Override
	public ResourceLocation getTextureLocation(LongShotProjectileEntity entity) {
		return TEXTURE;
	}
}