...
import zeldacraft.item.model.TwilightArmorModel;
...
public class TwilightArmorArmorRenderer extends GeoArmorRenderer<TwilightArmorItem> {
	public TwilightArmorArmorRenderer() {
		super(new TwilightArmorModel());
	...
	@Override
	public RenderType getRenderType(TwilightArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
