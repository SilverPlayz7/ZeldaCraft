...
public class DekuMaskRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = new ResourceLocation("zelda_craft", "textures/entities/dekumask.png");
	private final ModelDekuMask model;

	public DekuMaskRenderer() {
		this.model = new ModelDekuMask(Minecraft.getInstance().getEntityModels().bakeLayer(ZeldaCraftModLayerDefinitions.DEKU_MASK));
	}
