...
public class BlastMaskBaubleRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = new ResourceLocation("zelda_craft", "textures/entities/blastmask.png");
	private final ModelBlastMask model;

	public BlastMaskBaubleRenderer() {
		this.model = new ModelBlastMask(Minecraft.getInstance().getEntityModels().bakeLayer(ZeldaCraftModLayerDefinitions.BLAST_MASK));
	}
