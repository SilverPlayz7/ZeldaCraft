...
public class GaroMaskRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = new ResourceLocation("zelda_craft", "textures/entities/gaeromask.png");
	private final ModelGaro_Mask model;

	public GaroMaskRenderer() {
		this.model = new ModelGaro_Mask(Minecraft.getInstance().getEntityModels().bakeLayer(ZeldaCraftModLayerDefinitions.GARO_MASK));
	}
