...
import zeldacraft.item.model.GoldTimeArmorModel;
...
public class GoldTimeArmorArmorRenderer extends GeoArmorRenderer<GoldTimeArmorItem> {
	public GoldTimeArmorArmorRenderer() {
		super(new GoldTimeArmorModel());
	...
	@Override
	public RenderType getRenderType(GoldTimeArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
