...
import zeldacraft.world.features.StructureFeature;

import zeldacraft.init.ZeldaCraftModTabs;
import zeldacraft.init.ZeldaCraftModSounds;
...
public class ZeldaCraftMod {
	...
	public ZeldaCraftMod(FMLJavaModLoadingContext context) {
		...
		ZeldaCraftModItems.REGISTRY.register(bus);
