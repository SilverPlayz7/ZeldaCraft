...
public class TreasureChestTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public TreasureChestTileEntity(BlockPos pos, BlockState state) {
		super(ZeldaCraftModBlockEntities.TREASURE_CHEST.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(TreasureChestBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<TreasureChestTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<TreasureChestTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("treasure_chest");
	}
