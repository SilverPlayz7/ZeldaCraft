...
public class RoyalSarcophagusTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public RoyalSarcophagusTileEntity(BlockPos pos, BlockState state) {
		super(ZeldaCraftModBlockEntities.ROYAL_SARCOPHAGUS.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(RoyalSarcophagusBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<RoyalSarcophagusTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<RoyalSarcophagusTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("royal_sarcophagus");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Royal Sarcophagus");
	}
