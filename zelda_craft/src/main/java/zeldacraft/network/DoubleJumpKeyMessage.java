...
import zeldacraft.procedures.DoubleJumpProcedure;
...
public class DoubleJumpKeyMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		ZeldaCraftMod.addNetworkMessage(DoubleJumpKeyMessage.class, DoubleJumpKeyMessage::buffer, DoubleJumpKeyMessage::new, DoubleJumpKeyMessage::handler);
	}
}
