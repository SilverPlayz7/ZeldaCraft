...
import zeldacraft.item.SongSheetZeldasLullabyItem;
import zeldacraft.item.SongSheetVoidItem;
import zeldacraft.item.SongSheetSunsSongItem;
import zeldacraft.item.SongSheetSongOfTimeItem;
import zeldacraft.item.SongSheetSongOfStormsItem;
import zeldacraft.item.SongSheetSongOfSoaringItem;
import zeldacraft.item.SongSheetSongOfHealingItem;
import zeldacraft.item.SongSheetSongOfDoubleTimeItem;
import zeldacraft.item.SongSheetSonataOfAwakeningItem;
import zeldacraft.item.SongSheetSerenadeOfWaterItem;
import zeldacraft.item.SongSheetSariasSongItem;
import zeldacraft.item.SongSheetRequiemOfSpiritItem;
import zeldacraft.item.SongSheetPreludeOfLightItem;
import zeldacraft.item.SongSheetOathToOrderItem;
import zeldacraft.item.SongSheetNocturneOfShadowItem;
import zeldacraft.item.SongSheetNewWaveBossaNovaItem;
import zeldacraft.item.SongSheetMinuetOfForestItem;
import zeldacraft.item.SongSheetMasterItem;
import zeldacraft.item.SongSheetInvertedSongOfTimeItem;
import zeldacraft.item.SongSheetGoronLullabyItem;
import zeldacraft.item.SongSheetEponasSongItem;
import zeldacraft.item.SongSheetElegyOfEmptinessItem;
import zeldacraft.item.SongSheetBoleroOfFireItem;
...
import zeldacraft.item.ShockArrowItem;
...
import zeldacraft.item.RecruitSwordItem;
...
import zeldacraft.item.PureAlloyItem;
import zeldacraft.item.PhantomSwordItem;
...
import zeldacraft.item.GoddessWhiteswordItem;
import zeldacraft.item.GoddessSwordItem;
import zeldacraft.item.GoddessLongswordItem;
import zeldacraft.item.GildedSwordItem;
...
import zeldacraft.item.FireArrowItem;
...
import zeldacraft.item.CrimsonineItem;
...
public class ZeldaCraftModItems {
	...
	public static final RegistryObject<BlueTimeArmorItem> BLUE_TIME_ARMOR_HELMET = REGISTRY.register("blue_time_armor_helmet", () -> new BlueTimeArmorItem(ArmorItem.Type.HELMET, new Item.Properties()));
	public static final RegistryObject<BlueTimeArmorItem> BLUE_TIME_ARMOR_CHESTPLATE = REGISTRY.register("blue_time_armor_chestplate", () -> new BlueTimeArmorItem(ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final RegistryObject<BlueTimeArmorItem> BLUE_TIME_ARMOR_LEGGINGS = REGISTRY.register("blue_time_armor_leggings", () -> new BlueTimeArmorItem(ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final RegistryObject<RedTimeArmorItem> RED_TIME_ARMOR_HELMET = REGISTRY.register("red_time_armor_helmet", () -> new RedTimeArmorItem(ArmorItem.Type.HELMET, new Item.Properties()));
	public static final RegistryObject<RedTimeArmorItem> RED_TIME_ARMOR_CHESTPLATE = REGISTRY.register("red_time_armor_chestplate", () -> new RedTimeArmorItem(ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final RegistryObject<RedTimeArmorItem> RED_TIME_ARMOR_LEGGINGS = REGISTRY.register("red_time_armor_leggings", () -> new RedTimeArmorItem(ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final RegistryObject<GoldTimeArmorItem> GOLD_TIME_ARMOR_HELMET = REGISTRY.register("gold_time_armor_helmet", () -> new GoldTimeArmorItem(ArmorItem.Type.HELMET, new Item.Properties()));
	public static final RegistryObject<GoldTimeArmorItem> GOLD_TIME_ARMOR_CHESTPLATE = REGISTRY.register("gold_time_armor_chestplate", () -> new GoldTimeArmorItem(ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final RegistryObject<GoldTimeArmorItem> GOLD_TIME_ARMOR_LEGGINGS = REGISTRY.register("gold_time_armor_leggings", () -> new GoldTimeArmorItem(ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final RegistryObject<PurpleTimeArmorItem> PURPLE_TIME_ARMOR_HELMET = REGISTRY.register("purple_time_armor_helmet", () -> new PurpleTimeArmorItem(ArmorItem.Type.HELMET, new Item.Properties()));
	public static final RegistryObject<PurpleTimeArmorItem> PURPLE_TIME_ARMOR_CHESTPLATE = REGISTRY.register("purple_time_armor_chestplate", () -> new PurpleTimeArmorItem(ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final RegistryObject<PurpleTimeArmorItem> PURPLE_TIME_ARMOR_LEGGINGS = REGISTRY.register("purple_time_armor_leggings", () -> new PurpleTimeArmorItem(ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final RegistryObject<Item> BLUE_TIME_ARMOR_BUNDLE = REGISTRY.register("blue_time_armor_bundle", () -> new BlueTimeArmorBundleItem());
	public static final RegistryObject<Item> RED_TIME_ARMOR_BUNDLE = REGISTRY.register("red_time_armor_bundle", () -> new RedTimeArmorBundleItem());
	...
	public static final RegistryObject<Item> RECRUIT_SWORD = REGISTRY.register("recruit_sword", () -> new RecruitSwordItem());
	public static final RegistryObject<Item> PHANTOM_SWORD = REGISTRY.register("phantom_sword", () -> new PhantomSwordItem());
	public static final RegistryObject<Item> BOMBABLE_ILLUSION_BLOCK = block(ZeldaCraftModBlocks.BOMBABLE_ILLUSION_BLOCK);
	public static final RegistryObject<Item> BUNNY_HOOD_CONTRACT = REGISTRY.register("bunny_hood_contract", () -> new BunnyHoodContractItem());
	public static final RegistryObject<Item> SPIRIT_OF_THE_LOKOMO = REGISTRY.register("spirit_of_the_lokomo", () -> new SpiritOfTheLokomoItem());
	public static final RegistryObject<Item> CRIMSONINE = REGISTRY.register("crimsonine", () -> new CrimsonineItem());
	public static final RegistryObject<Item> AZURINE = REGISTRY.register("azurine", () -> new AzurineItem());
	public static final RegistryObject<Item> AQUANINE = REGISTRY.register("aquanine", () -> new AquanineItem());
	public static final RegistryObject<Item> PURE_ALLOY = REGISTRY.register("pure_alloy", () -> new PureAlloyItem());
	public static final RegistryObject<Item> PHANTOM_HOURGLASS = block(ZeldaCraftModBlocks.PHANTOM_HOURGLASS);
	public static final RegistryObject<Item> FLOOR_SWITCH = block(ZeldaCraftModBlocks.FLOOR_SWITCH);
	public static final RegistryObject<Item> SHEIKAH_LINK = block(ZeldaCraftModBlocks.SHEIKAH_LINK);
	public static final RegistryObject<Item> TIMED_FLOOR_SWITCH = block(ZeldaCraftModBlocks.TIMED_FLOOR_SWITCH);
	public static final RegistryObject<Item> WEIGHTED_FLOOR_SWITCH = block(ZeldaCraftModBlocks.WEIGHTED_FLOOR_SWITCH);
	public static final RegistryObject<Item> RUSTY_FLOOR_SWITCH = block(ZeldaCraftModBlocks.RUSTY_FLOOR_SWITCH);
	public static final RegistryObject<Item> LULLABY_SWITCH = block(ZeldaCraftModBlocks.LULLABY_SWITCH);
	public static final RegistryObject<Item> FIRE_ARROW = REGISTRY.register("fire_arrow", () -> new FireArrowItem());
	public static final RegistryObject<Item> ICE_ARROW = REGISTRY.register("ice_arrow", () -> new IceArrowItem());
	public static final RegistryObject<Item> LIGHT_ARROW = REGISTRY.register("light_arrow", () -> new LightArrowItem());
	public static final RegistryObject<Item> SILVER_ARROW = REGISTRY.register("silver_arrow", () -> new SilverArrowItem());
	...
	public static final RegistryObject<Item> GODDESS_LONGSWORD = REGISTRY.register("goddess_longsword", () -> new GoddessLongswordItem());
	public static final RegistryObject<Item> GODDESS_WHITESWORD = REGISTRY.register("goddess_whitesword", () -> new GoddessWhiteswordItem());
	public static final RegistryObject<Item> SONG_SHEET_MASTER = REGISTRY.register("song_sheet_master", () -> new SongSheetMasterItem());
	public static final RegistryObject<Item> SONG_SHEET_CURSED = REGISTRY.register("song_sheet_cursed", () -> new SongSheetVoidItem());
	public static final RegistryObject<Item> SONG_SHEET_ZELDAS_LULLABY = REGISTRY.register("song_sheet_zeldas_lullaby", () -> new SongSheetZeldasLullabyItem());
	public static final RegistryObject<Item> SONG_SHEET_EPONAS_SONG = REGISTRY.register("song_sheet_eponas_song", () -> new SongSheetEponasSongItem());
	public static final RegistryObject<Item> SONG_SHEET_SUNS_SONG = REGISTRY.register("song_sheet_suns_song", () -> new SongSheetSunsSongItem());
	public static final RegistryObject<Item> SONG_SHEET_SARIAS_SONG = REGISTRY.register("song_sheet_sarias_song", () -> new SongSheetSariasSongItem());
	public static final RegistryObject<Item> SONG_SHEET_SONG_OF_TIME = REGISTRY.register("song_sheet_song_of_time", () -> new SongSheetSongOfTimeItem());
	public static final RegistryObject<Item> SONG_SHEET_SONG_OF_STORMS = REGISTRY.register("song_sheet_song_of_storms", () -> new SongSheetSongOfStormsItem());
	public static final RegistryObject<Item> SONG_SHEET_MINUET_OF_FOREST = REGISTRY.register("song_sheet_minuet_of_forest", () -> new SongSheetMinuetOfForestItem());
	public static final RegistryObject<Item> SONG_SHEET_BOLERO_OF_FIRE = REGISTRY.register("song_sheet_bolero_of_fire", () -> new SongSheetBoleroOfFireItem());
	public static final RegistryObject<Item> SONG_SHEET_SERENADE_OF_WATER = REGISTRY.register("song_sheet_serenade_of_water", () -> new SongSheetSerenadeOfWaterItem());
	public static final RegistryObject<Item> SONG_SHEET_NOCTURNE_OF_SHADOW = REGISTRY.register("song_sheet_nocturne_of_shadow", () -> new SongSheetNocturneOfShadowItem());
	public static final RegistryObject<Item> SONG_SHEET_REQUIEM_OF_SPIRIT = REGISTRY.register("song_sheet_requiem_of_spirit", () -> new SongSheetRequiemOfSpiritItem());
	public static final RegistryObject<Item> SONG_SHEET_PRELUDE_OF_LIGHT = REGISTRY.register("song_sheet_prelude_of_light", () -> new SongSheetPreludeOfLightItem());
	public static final RegistryObject<Item> SONG_SHEET_SONG_OF_DOUBLE_TIME = REGISTRY.register("song_sheet_song_of_double_time", () -> new SongSheetSongOfDoubleTimeItem());
	public static final RegistryObject<Item> SONG_SHEET_INVERTED_SONG_OF_TIME = REGISTRY.register("song_sheet_inverted_song_of_time", () -> new SongSheetInvertedSongOfTimeItem());
	public static final RegistryObject<Item> SONG_SHEET_SONG_OF_HEALING = REGISTRY.register("song_sheet_song_of_healing", () -> new SongSheetSongOfHealingItem());
	public static final RegistryObject<Item> SONG_SHEET_SONG_OF_SOARING = REGISTRY.register("song_sheet_song_of_soaring", () -> new SongSheetSongOfSoaringItem());
	public static final RegistryObject<Item> SONG_SHEET_SONATA_OF_AWAKENING = REGISTRY.register("song_sheet_sonata_of_awakening", () -> new SongSheetSonataOfAwakeningItem());
	public static final RegistryObject<Item> SONG_SHEET_GORON_LULLABY = REGISTRY.register("song_sheet_goron_lullaby", () -> new SongSheetGoronLullabyItem());
	public static final RegistryObject<Item> SONG_SHEET_NEW_WAVE_BOSSA_NOVA = REGISTRY.register("song_sheet_new_wave_bossa_nova", () -> new SongSheetNewWaveBossaNovaItem());
	public static final RegistryObject<Item> SONG_SHEET_ELEGY_OF_EMPTINESS = REGISTRY.register("song_sheet_elegy_of_emptiness", () -> new SongSheetElegyOfEmptinessItem());
	public static final RegistryObject<Item> SONG_SHEET_OATH_TO_ORDER = REGISTRY.register("song_sheet_oath_to_order", () -> new SongSheetOathToOrderItem());
