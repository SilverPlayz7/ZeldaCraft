...
public class ZeldaCraftModGameRules {
	...
	public static final GameRules.Key<GameRules.BooleanValue> OCARINA_SONGS_NEED_UNLOCK = GameRules.register("ocarinaSongsNeedUnlock", GameRules.Category.PLAYER, GameRules.BooleanValue.create(true));
}