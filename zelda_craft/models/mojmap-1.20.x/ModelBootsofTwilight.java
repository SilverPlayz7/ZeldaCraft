...
public class ModelBootsofTwilight<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "bootsoftwilight"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Left = partdefinition.addOrReplaceChild("Left",
				CubeListBuilder.create().texOffs(42, 56)
						...
						.addBox(-2.1F, 11.1F, -4.5F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(52, 49)
						.addBox(-2.2F, 4.25F, -2.5F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(46, 49)
						.addBox(-1.7F, 4.25F, -2.5F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(49, 52)
						.addBox(-1.5F, 4.0F, -2.5F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-2.05F, 6.156F, -2.3112F, 4.0F, 5.75F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(1.2F, 6.156F, -2.3112F, 1.0F, 5.75F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-1.8F, 6.156F, 1.1388F, 4.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition Right = partdefinition.addOrReplaceChild("Right", CubeListBuilder.create().texOffs(0, 0).mirror()
				.addBox(-2.15F, 4.906F, -2.3112F, 1.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(42, 56).mirror().addBox(-2.2F, 11.1F, -4.5F, 4.0F, 1.0F, 7.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(48, 56).mirror()
				.addBox(1.15F, 11.1F, -4.5F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(46, 49)
				.mirror().addBox(-2.25F, 4.25F, -2.5F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(46, 49).mirror().addBox(1.25F, 4.25F, -2.5F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(0, 0).mirror()
				.addBox(-1.9F, 4.906F, -2.3112F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(0, 0).mirror().addBox(1.1F, 4.906F, 1.1388F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(0, 0).mirror()
				.addBox(-2.15F, 4.906F, 1.1388F, 4.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(49, 52).mirror().addBox(-1.5F, 4.0F, -2.5F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
