...
public class ModelFierceMask<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "fiercemask"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Mask = partdefinition.addOrReplaceChild("Mask", CubeListBuilder.create().texOffs(20, 20)
				.addBox(-4.0F, -7.975F, -4.025F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 20)
				.addBox(4.025F, -7.975F, -4.025F, 0.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 20).mirror()
				.addBox(-4.025F, -7.975F, -4.025F, 0.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(0, 0).addBox(-4.0F, 0.025F, -4.025F, 8.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r1 = Mask.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(8, 14).mirror()
						.addBox(0.0F, -0.194F, -1.4614F, 0.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r2 = Mask.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 14).mirror()
						.addBox(0.0F, -0.693F, -1.6528F, 0.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r3 = Mask.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 14).addBox(0.0F, -0.693F, -1.6528F, 0.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.9483F, -4.3647F, -1.0848F, 0.3074F, 0.7167F, 0.1976F));

		PartDefinition cube_r4 = Mask.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(10, 17)
						.addBox(0.0F, -0.944F, -1.4614F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 14)
						.addBox(0.0F, -0.194F, -1.4614F, 0.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.9821F, -3.9974F, -0.9575F, 0.6195F, 0.7291F, 0.1418F));

		PartDefinition Hair = Mask.addOrReplaceChild("Hair", CubeListBuilder.create().texOffs(6, 46).addBox(-0.3608F,
				-9.3988F, -5.0252F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.25F, 0.0F, 0.0F));

		PartDefinition cube_r5 = Hair.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(44, 11)
						.addBox(-3.25F, -0.75F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 20)
						.addBox(1.7783F, -0.75F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(36, 24)
						.addBox(-1.2217F, -1.25F, -1.5F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = Hair.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(52, 48).addBox(-0.8186F, -2.7926F, 0.0504F, 1.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = Hair.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(36, 9).addBox(-0.4436F, -1.171F, 1.6382F, 1.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = Hair.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(0, 33).addBox(-0.6786F, -2.1409F, 0.8029F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = Hair.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(48, 49).addBox(0.0617F, 0.1924F, -1.6547F, 1.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = Hair.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(24, 49).addBox(0.1296F, 0.1724F, -1.0301F, 1.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11 = Hair.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(29, 53).addBox(-0.7F, -1.5F, 0.0F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.95F, -4.5F, -5.9F, 0.1745F, -0.5236F, 0.0F));

		PartDefinition cube_r12 = Hair.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(25, 53).addBox(-1.7254F, -2.3305F, -1.4573F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r13 = Hair.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.015F, -2.2043F, -1.5943F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = Hair.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(0, 5).addBox(0.015F, -2.264F, -0.7055F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r15 = Hair.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(44, 46).addBox(0.0786F, -3.1071F, -0.0994F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r16 = Hair.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(0, 48).addBox(-1.0F, -3.0F, 0.0F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r17 = Hair.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(14, 46).addBox(0.0207F, -2.1695F, -0.703F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r18 = Hair.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(34, 3).addBox(0.0F, 0.0F, -4.0F, 1.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r19 = Hair.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(0, 33).addBox(-1.0F, 0.0F, -1.0F, 1.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r20 = Hair.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(52, 5).addBox(0.0F, 0.0F, -1.0F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r21 = Hair.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(0, 44).addBox(-2.0F, 0.0F, -2.0F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r22 = Hair.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(42, 51).addBox(0.3F, -0.2F, -0.7F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r23 = Hair.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(52, 31).addBox(-2.0F, 0.0F, 0.0F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r24 = Hair.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(12, 41).addBox(-1.9989F, -0.5462F, 0.5642F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r25 = Hair.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(50, 18).addBox(-1.8629F, -0.2155F, 0.0094F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r26 = Hair.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(12, 51).addBox(-2.0862F, -0.1084F, -0.948F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r27 = Hair.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(12, 30).addBox(-2.1963F, -0.4014F, -2.5006F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r28 = Hair.addOrReplaceChild("cube_r28",
				CubeListBuilder.create().texOffs(18, 49).addBox(-0.6F, 0.0F, -1.95F, 1.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r29 = Hair.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(30, 49).addBox(-1.0F, 0.0F, -2.0F, 1.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r30 = Hair.addOrReplaceChild("cube_r30",
				CubeListBuilder.create().texOffs(7, 41).addBox(0.0F, 0.0F, -2.85F, 1.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r31 = Hair.addOrReplaceChild("cube_r31",
				CubeListBuilder.create().texOffs(52, 41).addBox(-2.0F, 0.0F, -1.0F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r32 = Hair.addOrReplaceChild("cube_r32",
				CubeListBuilder.create().texOffs(20, 41).addBox(-1.0F, 0.0F, -1.0F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r33 = Hair.addOrReplaceChild("cube_r33",
				CubeListBuilder.create().texOffs(21, 45).addBox(-1.8399F, 0.1221F, 0.0594F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r34 = Hair.addOrReplaceChild("cube_r34",
				CubeListBuilder.create().texOffs(6, 49).addBox(-0.0004F, 0.2072F, 0.0119F, 1.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r35 = Hair.addOrReplaceChild("cube_r35",
				CubeListBuilder.create().texOffs(17, 53).addBox(-0.4F, 0.0F, -0.95F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r36 = Hair.addOrReplaceChild("cube_r36",
				CubeListBuilder.create().texOffs(21, 53).addBox(-1.0F, 0.0F, -1.0F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r37 = Hair.addOrReplaceChild("cube_r37",
				CubeListBuilder.create().texOffs(32, 41).addBox(0.0F, 0.0F, 0.0F, 1.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r38 = Hair.addOrReplaceChild("cube_r38",
				CubeListBuilder.create().texOffs(41, 15).addBox(0.0F, 0.0F, -3.0F, 1.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r39 = Hair.addOrReplaceChild("cube_r39",
				CubeListBuilder.create().texOffs(41, 6).addBox(-1.0F, 0.0F, -2.85F, 1.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r40 = Hair.addOrReplaceChild("cube_r40",
				CubeListBuilder.create().texOffs(36, 51).addBox(-0.1371F, -0.2155F, 0.0094F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r41 = Hair.addOrReplaceChild("cube_r41",
				CubeListBuilder.create().texOffs(51, 35).addBox(-0.0011F, -0.4712F, 0.5642F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r42 = Hair.addOrReplaceChild("cube_r42",
				CubeListBuilder.create().texOffs(0, 53).addBox(0.0862F, -0.1084F, -0.948F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r43 = Hair.addOrReplaceChild("cube_r43",
				CubeListBuilder.create().texOffs(14, 37).addBox(0.225F, -0.1F, -1.0F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.1581F, -6.1869F, -7.8352F, 2.1547F, -1.0139F, -0.0439F));

		PartDefinition cube_r44 = Hair.addOrReplaceChild("cube_r44",
				CubeListBuilder.create().texOffs(52, 11).addBox(0.1963F, -0.4014F, -1.5006F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r45 = Hair.addOrReplaceChild("cube_r45",
				CubeListBuilder.create().texOffs(52, 14).addBox(-2.0F, 0.0F, -1.0F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r46 = Hair.addOrReplaceChild("cube_r46",
				CubeListBuilder.create().texOffs(52, 21).addBox(0.0F, 0.0F, -1.0F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r47 = Hair.addOrReplaceChild("cube_r47",
				CubeListBuilder.create().texOffs(33, 53).addBox(-0.0797F, -0.0108F, 0.0409F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r48 = Hair.addOrReplaceChild("cube_r48",
				CubeListBuilder.create().texOffs(17, 37).addBox(-1.0865F, -0.7136F, -0.248F, 2.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r49 = Hair.addOrReplaceChild("cube_r49",
				CubeListBuilder.create().texOffs(45, 38).addBox(0.0F, 0.0F, -2.0F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r50 = Hair.addOrReplaceChild("cube_r50",
				CubeListBuilder.create().texOffs(45, 42).addBox(0.0F, 0.0F, 0.0F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r51 = Hair.addOrReplaceChild("cube_r51",
				CubeListBuilder.create().texOffs(6, 53).addBox(0.0727F, 0.2542F, 0.0323F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r52 = Hair.addOrReplaceChild("cube_r52",
				CubeListBuilder.create().texOffs(53, 38).addBox(-0.0797F, -0.0108F, 0.0409F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r53 = Hair.addOrReplaceChild("cube_r53",
				CubeListBuilder.create().texOffs(38, 44).addBox(-2.0F, 0.0F, -2.0F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r54 = Hair.addOrReplaceChild("cube_r54",
				CubeListBuilder.create().texOffs(10, 39).addBox(0.0F, 0.0F, 0.0F, 2.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r56 = Hair.addOrReplaceChild("cube_r56",
				CubeListBuilder.create().texOffs(7, 38).addBox(-1.0F, -0.3F, -1.0F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.2733F, -9.4943F, -4.15F, 0.0F, 0.0F, 0.2618F));

		PartDefinition cube_r57 = Hair.addOrReplaceChild("cube_r57",
				CubeListBuilder.create().texOffs(48, 46).addBox(-1.2909F, -1.2161F, 1.3697F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r58 = Hair.addOrReplaceChild("cube_r58",
				CubeListBuilder.create().texOffs(48, 3).addBox(-4.0F, 0.0F, -1.0F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r59 = Hair.addOrReplaceChild("cube_r59",
				CubeListBuilder.create().texOffs(49, 9).addBox(-2.0F, -0.2F, 0.0F, 2.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r60 = Hair.addOrReplaceChild("cube_r60",
				CubeListBuilder.create().texOffs(49, 9).addBox(-2.0F, 0.0F, 0.0F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r61 = Hair.addOrReplaceChild("cube_r61",
				CubeListBuilder.create().texOffs(0, 40).addBox(0.0F, 0.0F, 0.0F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.3169F, -9.5253F, -5.15F, 0.0F, 0.0F, 0.829F));

		PartDefinition cube_r62 = Hair.addOrReplaceChild("cube_r62",
				CubeListBuilder.create().texOffs(18, 6).addBox(0.0F, 0.0F, -1.0F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r63 = Hair.addOrReplaceChild("cube_r63",
				CubeListBuilder.create().texOffs(49, 27).addBox(0.0F, 0.0F, -2.0F, 1.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r64 = Hair.addOrReplaceChild("cube_r64",
				CubeListBuilder.create().texOffs(41, 3).addBox(0.0F, 0.0F, 0.0F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r65 = Hair.addOrReplaceChild("cube_r65",
				CubeListBuilder.create().texOffs(41, 3).addBox(-3.0F, 0.0F, 0.0F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r66 = Hair.addOrReplaceChild("cube_r66",
				CubeListBuilder.create().texOffs(47, -1).addBox(-2.5376F, -0.8207F, -1.2933F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r67 = Hair.addOrReplaceChild("cube_r67",
				CubeListBuilder.create().texOffs(46, 15).addBox(-0.2878F, 0.0656F, -0.2011F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r68 = Hair.addOrReplaceChild("cube_r68",
				CubeListBuilder.create().texOffs(46, 6).addBox(-2.0F, 0.0F, -2.0F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r69 = Hair.addOrReplaceChild("cube_r69",
				CubeListBuilder.create().texOffs(29, 46).addBox(-0.2744F, 0.1087F, -0.2011F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r70 = Hair.addOrReplaceChild("cube_r70",
				CubeListBuilder.create().texOffs(26, 28).addBox(0.0F, -1.0F, -2.0F, 6.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r71 = Hair.addOrReplaceChild("cube_r71",
				CubeListBuilder.create().texOffs(34, 32).addBox(-7.0F, -1.0F, -2.0F, 4.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r72 = Hair.addOrReplaceChild("cube_r72",
				CubeListBuilder.create().texOffs(40, 29).addBox(-0.1302F, -0.1659F, -1.9471F, 3.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r73 = Hair.addOrReplaceChild("cube_r73",
				CubeListBuilder.create().texOffs(10, 25).addBox(0.0F, 0.0F, -2.0F, 3.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r74 = Hair.addOrReplaceChild("cube_r74",
				CubeListBuilder.create().texOffs(46, 32).addBox(-5.6F, 0.5F, -1.5F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r75 = Hair.addOrReplaceChild("cube_r75",
				CubeListBuilder.create().texOffs(22, 31).addBox(-0.9357F, -0.7678F, -1.0817F, 5.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r76 = Hair.addOrReplaceChild("cube_r76",
				CubeListBuilder.create().texOffs(35, 0).addBox(-1.2395F, -0.79F, -0.6891F, 4.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r77 = Hair.addOrReplaceChild("cube_r77",
				CubeListBuilder.create().texOffs(25, 32).addBox(0.0F, 0.0F, 0.0F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r78 = Hair.addOrReplaceChild("cube_r78",
				CubeListBuilder.create().texOffs(24, 31).addBox(0.0F, 0.0F, -2.0F, 3.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r79 = Hair.addOrReplaceChild("cube_r79",
				CubeListBuilder.create().texOffs(38, 42).addBox(-3.0F, 0.0F, 0.0F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r80 = Hair.addOrReplaceChild("cube_r80",
				CubeListBuilder.create().texOffs(41, 35).addBox(-3.0F, 0.0F, 0.0F, 3.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r81 = Hair.addOrReplaceChild("cube_r81",
				CubeListBuilder.create().texOffs(48, 24).addBox(0.0F, 0.0F, 0.0F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r82 = Hair.addOrReplaceChild("cube_r82",
				CubeListBuilder.create().texOffs(35, 48).addBox(-2.0F, 0.0F, 0.0F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.246F, -10.502F, -5.15F, 0.0F, 0.0F, -0.3491F));

		PartDefinition cube_r83 = Hair.addOrReplaceChild("cube_r83",
				CubeListBuilder.create().texOffs(16, 42).addBox(-1.0F, 0.0F, 0.0F, 1.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r84 = Hair.addOrReplaceChild("cube_r84",
				CubeListBuilder.create().texOffs(17, 43).addBox(0.0F, -2.2F, 0.0F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r85 = Hair.addOrReplaceChild("cube_r85",
				CubeListBuilder.create().texOffs(16, 42).addBox(0.05F, -2.0F, -2.05F, 1.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r86 = Hair.addOrReplaceChild("cube_r86",
				CubeListBuilder.create().texOffs(45, 27).addBox(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r87 = Hair.addOrReplaceChild("cube_r87",
				CubeListBuilder.create().texOffs(45, 27).addBox(-1.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r88 = Hair.addOrReplaceChild("cube_r88",
				CubeListBuilder.create().texOffs(44, 26).addBox(-1.0F, -0.3F, -1.0F, 1.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone2 = Hair.addOrReplaceChild("bone2", CubeListBuilder.create(),
				PartPose.offset(-3.2914F, -0.0687F, 0.8205F));

		PartDefinition cube_r89 = bone2.addOrReplaceChild("cube_r89",
				CubeListBuilder.create().texOffs(42, 11).mirror()
						.addBox(0.0F, -1.0F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2321F, -0.0282F, -1.1707F));

		PartDefinition cube_r90 = bone2.addOrReplaceChild("cube_r90",
				CubeListBuilder.create().texOffs(42, 11).addBox(-1.0F, -1.0F, 0.0F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.0827F, 0.0F, 0.0F, -0.2321F, 0.0282F, 1.1707F));

		PartDefinition cube_r91 = bone2.addOrReplaceChild("cube_r91",
				CubeListBuilder.create().texOffs(36, 35).addBox(0.1F, 4.0012F, -0.01F, 1.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r92 = bone2.addOrReplaceChild("cube_r92",
				CubeListBuilder.create().texOffs(33, 0)
						.addBox(-4.0F, 0.25F, -0.45F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(10, 28)
		...
		PartDefinition cube_r93 = bone2.addOrReplaceChild("cube_r93",
				CubeListBuilder.create().texOffs(0, 20).addBox(-4.75F, 0.25F, -0.5F, 9.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.7914F, -4.1984F, -0.954F, 0.3491F, 0.0F, 0.0F));

		PartDefinition cube_r94 = bone2.addOrReplaceChild("cube_r94",
		...
		PartDefinition cube_r95 = bone2.addOrReplaceChild("cube_r95",
				CubeListBuilder.create().texOffs(17, 31)
						.addBox(-4.0F, 0.25F, 0.55F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(7, 31)
						.addBox(3.5F, 0.25F, 0.55F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(1, 6)
						.addBox(-3.45F, 0.275F, 0.425F, 7.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.2914F, -8.916F, -3.0117F, 0.0436F, 0.0F, 0.0F));

		PartDefinition cube_r96 = bone2.addOrReplaceChild("cube_r96",
				CubeListBuilder.create().texOffs(22, 1).addBox(-5.0F, 0.0F, 0.0F, 5.0F, 5.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r97 = bone2.addOrReplaceChild("cube_r97",
				CubeListBuilder.create().texOffs(23, 8).addBox(0.0F, 0.0F, 0.0F, 5.0F, 5.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.7086F, -7.7597F, -2.0891F, 0.4366F, 0.0316F, 0.0148F));

		PartDefinition cube_r98 = bone2.addOrReplaceChild("cube_r98",
				CubeListBuilder.create().texOffs(36, 18).addBox(-1.1F, 4.0012F, -0.01F, 1.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.7914F, -6.9212F, 4.7353F, -1.3538F, -0.0226F, 0.1023F));

		PartDefinition cube_r99 = bone2.addOrReplaceChild("cube_r99",
				CubeListBuilder.create().texOffs(24, 40).addBox(1.0F, -0.5F, -3.0F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r100 = bone2.addOrReplaceChild("cube_r100",
				CubeListBuilder.create().texOffs(35, 13).addBox(-3.0F, 0.0F, 0.0F, 3.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r101 = bone2.addOrReplaceChild("cube_r101",
				CubeListBuilder.create().texOffs(27, 35).addBox(0.0F, 0.0F, 0.0F, 3.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.7086F, -4.1345F, -0.3986F, 0.3503F, 0.082F, 0.0299F));

		PartDefinition cube_r102 = bone2.addOrReplaceChild("cube_r102",
				CubeListBuilder.create().texOffs(17, 15).addBox(-5.75F, -0.5F, -3.0F, 7.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.7914F, -2.0481F, -0.1918F, 2.3125F, 0.0F, 0.0F));

		PartDefinition cube_r103 = bone2.addOrReplaceChild("cube_r103",
				CubeListBuilder.create().texOffs(24, 40).mirror()
						.addBox(-2.0F, -0.5F, -3.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
