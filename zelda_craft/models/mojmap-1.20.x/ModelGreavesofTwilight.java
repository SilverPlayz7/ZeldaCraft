...
public class ModelGreavesofTwilight<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "greavesoftwilight"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Left = partdefinition.addOrReplaceChild("Left", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-2.025F, -0.025F, -2.025F, 4.05F, 10.0F, 4.05F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, 12.0F, 0.0F));

		PartDefinition Right = partdefinition.addOrReplaceChild("Right", CubeListBuilder.create().texOffs(0, 0).mirror()
				.addBox(-6.025F, -0.025F, -2.025F, 4.05F, 10.0F, 4.05F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(2.0F, 12.0F, 0.0F));

		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(12, 12)
						.addBox(-4.0F, -12.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
