...
public class ModelIronBoots<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "ironboots"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r12 = bone4.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(7, 52)
		...
		PartDefinition cube_r15 = bone9.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(6, 51).mirror()
		...
		PartDefinition cube_r22 = bone17.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(3, 48).mirror()
		...
		PartDefinition cube_r23 = bone19.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(3, 48).mirror()
		...
		PartDefinition cube_r27 = bone26.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(7, 52).mirror()
		...
		PartDefinition cube_r28 = bone27.addOrReplaceChild("cube_r28",
		...
		PartDefinition cube_r30 = bone29.addOrReplaceChild("cube_r30",
