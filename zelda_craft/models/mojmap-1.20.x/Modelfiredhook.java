...
public class Modelfiredhook<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create(),
				PartPose.offset(-0.8034F, 8.0891F, 0.0F));

		PartDefinition cube_r1 = bone
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(10, 15).addBox(-0.5F, -2.0F, -0.5F, 1.0F, 4.0F, 1.0F,
		...
		PartDefinition bone2 = partdefinition.addOrReplaceChild("bone2", CubeListBuilder.create(),
				PartPose.offset(0.0F, 8.0891F, -0.8034F));

		PartDefinition cube_r2 = bone2.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(10, 15).addBox(-0.5F, 0.225F, -0.5F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(10, 16)
						.addBox(-0.5F, -17.95F, -0.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(10, 22)
						.addBox(-0.5F, -13.45F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
