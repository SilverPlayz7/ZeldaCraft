...
public class ModelShockArrow<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "shockarrow"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = arrow.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(18, 0).mirror()
						.addBox(-1.2907F, 0.9978F, 0.0F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r2 = arrow.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(18, 0).addBox(-0.7093F, 0.9978F, 0.0F, 2.0F, 1.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1178F, 0.432F, -5.8532F, 1.5708F, -0.7854F, -3.1416F));

		PartDefinition cube_r3 = arrow.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(10, 0).addBox(0.2364F, -5.4086F, 0.0F, 4.0F, 7.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = arrow.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(10, 0).mirror()
						.addBox(-4.2364F, -5.4086F, 0.0F, 4.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1178F, 0.432F, -5.8532F, 1.5708F, 0.2618F, -3.1416F));

		PartDefinition cube_r5 = arrow.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(5, 8).addBox(-2.5F, -4.5F, -2.5F, 5.0F, 0.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = arrow.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(-13, 0).addBox(-2.5F, 0.0F, -6.5F, 5.0F, 0.0F, 13.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0928F, 0.4073F, 2.0718F, 3.1416F, 0.0F, -2.3562F));

		PartDefinition cube_r7 = arrow.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(-13, 0).addBox(-2.5F, 0.0F, -6.5F, 5.0F, 0.0F, 13.0F,
						new CubeDeformation(0.0F)),
