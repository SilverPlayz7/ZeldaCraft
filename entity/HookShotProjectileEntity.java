...
public class HookShotProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public static HookShotProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 1f, 5, 0);
	}

	public static HookShotProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
	...
	public static HookShotProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		HookShotProjectileEntity entityarrow = new HookShotProjectileEntity(ZeldaCraftModEntities.HOOK_SHOT_PROJECTILE.get(), entity, entity.level());
