...
import zeldacraft.item.model.TimeArmorModel;
...
public class TimeArmorArmorRenderer extends GeoArmorRenderer<TimeArmorItem> {
	public TimeArmorArmorRenderer() {
		super(new TimeArmorModel());
	...
	@Override
	public RenderType getRenderType(TimeArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
