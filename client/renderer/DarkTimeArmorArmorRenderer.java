...
import zeldacraft.item.model.DarkTimeArmorModel;
...
public class DarkTimeArmorArmorRenderer extends GeoArmorRenderer<DarkTimeArmorItem> {
	public DarkTimeArmorArmorRenderer() {
		super(new DarkTimeArmorModel());
	...
	@Override
	public RenderType getRenderType(DarkTimeArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
