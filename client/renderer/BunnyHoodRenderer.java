...
public class BunnyHoodRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = new ResourceLocation("zelda_craft", "textures/entities/bunnyhood.png");
	private final ModelBunnyHood model;

	public BunnyHoodRenderer() {
		this.model = new ModelBunnyHood(Minecraft.getInstance().getEntityModels().bakeLayer(ZeldaCraftModLayerDefinitions.BUNNY_HOOD));
	}
